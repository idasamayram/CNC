...
def stratified_group_split(data_directory="../data/final/new_selection/normalized_windowed_downsampled_data_lessBAD",
    ...
    sgkf = StratifiedGroupKFold(n_splits=10, shuffle=True, random_state=None)
    ...
    sgkf_temp = StratifiedGroupKFold(n_splits=2, shuffle=True, random_state=None)
...
def stratified_group_split_freq(data_directory="../data/final/new_selection/normalized_windowed_downsampled_data_lessBAD",
